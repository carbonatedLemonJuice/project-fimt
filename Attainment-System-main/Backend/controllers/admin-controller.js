...
const adminRegister = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error during admin registration" });
  }
};
...
const getAdminDetail = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching admin details" });
  }
};
...
const GetFinalAttainmentData = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error fetching attainment data" });
  }
};
...
const GetFinalAttainmentPOs = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error fetching PO attainment" });
  }
};
