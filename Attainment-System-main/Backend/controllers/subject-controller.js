...
const classSubjects = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching class subjects" });
  }
};
...
const freeSubjectList = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching free subjects" });
  }
};
...
const getSubjectDetail = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching subject details" });
  }
}
...
const deleteSubjects = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error deleting subjects" });
  }
};
...
const deleteSubjectsByClass = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error deleting subjects by class" });
  }
};
