...
const teacherRegister = async (req, res) => {
  ...
  try {
    ...
    if (teachSubject) teacherData.teachSubject = [teachSubject];
    if (teachSclass) teacherData.teachSclass = teachSclass;
    ...
    if (existingTeacherByEmail) {
      ...
      res.status(200).json(existingTeacherByEmail);
    }
    else {
    ...
    res.status(500).json({ message: err.message || "Error during teacher registration" });
  }
};
...
const teacherLogIn = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error during teacher login" });
  }
};
...
const allteachers = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching all teachers" });
  }
};
...
const getTeacherDetail = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: err.message || "Error fetching teacher details" });
  }
};
...
const updateTeacherSubject = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: error.message || "Error updating teacher subject" });
  }
};
...
const deleteTeachers = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error deleting teachers" });
  }
};
...
const deleteTeachersByClass = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: error.message || "Error deleting teachers by class" });
  }
};
